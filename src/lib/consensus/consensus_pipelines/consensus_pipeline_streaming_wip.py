...
def refine_consensus_sequence(consensus_path, output_dir, block_num):
    ...
    try:
        ...
        # logger.info(f"Percentage Dominance of {most_common} at First Position: {percentage_dominance:.2f}%")
...
def run_consensus_streaming_pipeline_wip(input_name: str, input_fastq_path: str, output_dir: str, logger, block_size=3000):
